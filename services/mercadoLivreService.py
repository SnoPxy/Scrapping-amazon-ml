...
class MercadoLivreService:
    ...
    def valor_mercado_livre(self):
        prod_links_mercado_livre = self.mercado_livre(self.product_name, self.link_count)
        products = []  
    ...
    def mercado_livre(self, product_name,link_count):
        ...
        for selenium in search_links:
            ...
            if link and len(links) < link_count:  
                links.append(link)
